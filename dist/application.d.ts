...
declare const MainApplication_base: (new (...args: any[]) => {
    ...
    configure: <ConfigValueType = any>(key?: string | BindingKey<unknown> | undefined) => import("@loopback/boot").Binding<ConfigValueType>;
    ...
    getOwnerContext: (keyOrBinding: string | BindingKey<unknown> | Readonly<import("@loopback/boot").Binding<unknown>>) => import("@loopback/core").Context | undefined;
    ...
    mountComponentServices<C_1_1 extends import("@loopback/core").Component = import("@loopback/core").Component>(component: import("@loopback/core").Constructor<C_1_1>, componentBindingKey?: string | BindingKey<C_1_1> | undefined): void;
    readonly options: ApplicationConfig;
    readonly state: string;
    ...
    add: (binding: import("@loopback/boot").Binding<unknown>) => import("@loopback/core").Application;
    configure: <ConfigValueType_4 = any>(key?: string | BindingKey<unknown> | undefined) => import("@loopback/boot").Binding<ConfigValueType_4>;
    ...
    add: (binding: import("@loopback/boot").Binding<unknown>) => import("@loopback/core").Application;
    configure: <ConfigValueType_5 = any>(key?: string | BindingKey<unknown> | undefined) => import("@loopback/boot").Binding<ConfigValueType_5>;
